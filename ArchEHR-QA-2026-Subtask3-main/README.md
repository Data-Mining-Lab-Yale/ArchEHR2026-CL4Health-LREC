...
Pipeline for **Subtask 3**: generate an answer of at most 75 words grounded in the provided clinical note (professional register, no citations). Evaluation: BLEU, ROUGE, SARI, BERTScore (and optionally AlignScore/MEDCON in the official environment; this repo uses locally reproducible metrics).
